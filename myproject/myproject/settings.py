...
SECRET_KEY = 'django-insecure-4r4!9ylirq&as-v(s@_3bpi95p2kgcke6@!s($^f3lh_sestb#'
...
# Add this if you have issues with CSRF
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.token_authenticator.TokenAuthentication',
    ],
...
SAML_FOLDER = os.path.join(BASE_DIR, 'app')

OPEN_TEXT_IDP_FOLDER = os.path.join(BASE_DIR, 'OpenText')
